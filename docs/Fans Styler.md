...
Fans Styler节点旨在为输入文本应用特定的样式选项，允许根据预定义的样式自定义文本输出。它支持多种样式，可以单独或组合应用，从而增强文本的呈现效果或使其适应各种上下文。

# Input types
## Required
- **`with_comma_condition`**
    - 决定样式化后的文本是否应该用逗号分隔，影响输出的可读性和格式。
    - Comfy dtype: `COMBO[STRING]`
    - Python dtype: `str`
- **`style1`**
    - 选择应用于输入文本第一部分的特定样式，影响其美学或主题呈现。
    - Comfy dtype: `COMBO[STRING]`
    - Python dtype: `str`
- **`style2`**
    - 选择应用于输入文本第二部分的特定样式，影响其美学或主题呈现。
    - Comfy dtype: `COMBO[STRING]`
    - Python dtype: `str`
- **`style3`**
    - 选择应用于输入文本第三部分的特定样式，影响其美学或主题呈现。
    - Comfy dtype: `COMBO[STRING]`
    - Python dtype: `str`
- **`style4`**
    - 选择应用于输入文本第四部分的特定样式，影响其美学或主题呈现。
    - Comfy dtype: `COMBO[STRING]`
    - Python dtype: `str`
- **`style5`**
    - 选择应用于输入文本第五部分的特定样式，影响其美学或主题呈现。
    - Comfy dtype: `COMBO[STRING]`
    - Python dtype: `str`
- **`style6`**
    - 选择应用于输入文本第六部分的特定样式，影响其美学或主题呈现。
    - Comfy dtype: `COMBO[STRING]`
    - Python dtype: `str`
- **`style7`**
    - 选择应用于输入文本第七部分的特定样式，影响其美学或主题呈现。
    - Comfy dtype: `COMBO[STRING]`
    - Python dtype: `str`
- **`style8`**
    - 选择应用于输入文本第八部分的特定样式，影响其美学或主题呈现。
    - Comfy dtype: `COMBO[STRING]`
    - Python dtype: `str`
- **`style9`**
    - 选择应用于输入文本第九部分的特定样式，影响其美学或主题呈现。
    - Comfy dtype: `COMBO[STRING]`
    - Python dtype: `str`
- **`style10`**
    - 选择应用于输入文本第十部分的特定样式，影响其美学或主题呈现。
    - Comfy dtype: `COMBO[STRING]`
    - Python dtype: `str`
...
- **`STYLE 1`**
    - Comfy dtype: `STRING`
    - 表示根据style1选项样式化后的文本，提供自定义的文本呈现。
    - Python dtype: `str`
- **`STYLE 2`**
    - Comfy dtype: `STRING`
    - 表示根据style2选项样式化后的文本，提供自定义的文本呈现。
    - Python dtype: `str`
- **`STYLE 3`**
    - Comfy dtype: `STRING`
    - 表示根据style3选项样式化后的文本，提供自定义的文本呈现。
    - Python dtype: `str`
- **`STYLE 4`**
    - Comfy dtype: `STRING`
    - 表示根据style4选项样式化后的文本，提供自定义的文本呈现。
    - Python dtype: `str`
- **`STYLE 5`**
    - Comfy dtype: `STRING`
    - 表示根据style5选项样式化后的文本，提供自定义的文本呈现。
    - Python dtype: `str`
- **`STYLE 6`**
    - Comfy dtype: `STRING`
    - 表示根据style6选项样式化后的文本，提供自定义的文本呈现。
    - Python dtype: `str`
- **`STYLE 7`**
    - Comfy dtype: `STRING`
    - 表示根据style7选项样式化后的文本，提供自定义的文本呈现。
    - Python dtype: `str`
- **`STYLE 8`**
    - Comfy dtype: `STRING`
    - 表示根据style8选项样式化后的文本，提供自定义的文本呈现。
    - Python dtype: `str`
- **`STYLE 9`**
    - Comfy dtype: `STRING`
    - 表示根据style9选项样式化后的文本，提供自定义的文本呈现。
    - Python dtype: `str`
- **`STYLE 10`**
    - Comfy dtype: `STRING`
    - 表示根据style10选项样式化后的文本，提供自定义的文本呈现。
    - Python dtype: `str`
